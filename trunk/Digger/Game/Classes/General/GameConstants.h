...
#define NOTIFICATION_KNAPSACK_FULL @"NOTIFICATION_KNAPSACK_FULL"
#define NOTIFICATION_ANIMATE_POWER @"NOTIFICATION_ANIMATE_POWER"
#define NOTIFICATION_ANIMATE_TREASURE @"NOTIFICATION_ANIMATE_TREASURE"
#define NOTIFICATION_ANIMATE_FOR_BLOCK_QUEUE @"NOTIFICATION_ANIMATE_FOR_BLOCK_QUEUE"
