...
#define UNLOCK_ANSWER_NOTIFICATION @"UNLOCK_ANSWER_NOTIFICATION"
#define ADD_KEY_NOTIFICATION @"ADD_KEY_NOTIFICATION"
#define BUY_COIN_VIEW_NOTIFICATION @"BUY_COIN_VIEW_NOTIFICATION"
#define BUY_COIN_VIEW_DISMISS_NOTIFICATION @"BUY_COIN_VIEW_DISMISS_NOTIFICATION"
#define APPLY_TRANSACTION_NOTIFICATION @"APPLY_TRANSACTION_NOTIFICATION"
#define APPLY_TRANSACTION_EFFECT_NOTIFICATION @"APPLY_TRANSACTION_EFFECT_NOTIFICATION"
...
#define ANIMATE_CORRECT_WORD_NOTIFICATION @"ANIMATE_CORRECT_WORD_NOTIFICATION"
